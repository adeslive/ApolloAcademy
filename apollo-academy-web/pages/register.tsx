                ...
                {({values, isSubmitting}) => (
                    <Form>
                        ...
                        <Stack>
                            ...
                            <hr/>
                            <a><Button mt={1} width="100%" type="button" colorScheme="facebook"><Image src="facebook_icon.png" boxSize="5" borderRadius="full" marginX="2"/>Registrarse con Facebook</Button></a>
                            <a><Button mt={1} width="100%" type="button" colorScheme="gray"><Image src="gmail_icon.png" boxSize="5" borderRadius="full" marginX="2"/>Registrarse con Google</Button></a>
                        </Stack>
                    </Form>
                )}
            </Formik>
